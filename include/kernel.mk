...
# override possible kernel source options
ifdef KERNEL_GIT_CLONE_URI
CONFIG_KERNEL_GIT_CLONE_URI:=$(KERNEL_GIT_CLONE_URI)
endif

ifdef KERNEL_GIT_REF
CONFIG_KERNEL_GIT_REF:=$(KERNEL_GIT_REF)
endif

ifdef EXTERNAL_KERNEL_TREE
CONFIG_EXTERNAL_KERNEL_TREE:=$(EXTERNAL_KERNEL_TREE)
endif

ifdef KERNEL_GIT_LOCAL_REPOSITORY
CONFIG_KERNEL_GIT_LOCAL_REPOSITORY:=$(KERNEL_GIT_LOCAL_REPOSITORY)
endif
...
CompareKernelPatchVer=$(if $(call kernel_version_cmp,-$(2),$(shell echo $(1) | sed 's/^[A-Za-z]*//'),$(3)),1,0)
