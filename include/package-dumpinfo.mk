...
)$(if $(PKG_UPSTREAM_URL),Upstream: $(PKG_UPSTREAM_URL)
)$(if $(USERID),Require-User: $(USERID)
)$(if $(USER_GROUPS),Groups: $(USER_GROUPS)
...
)Detail-Description: $(if $(Package/$(1)/description_detail),$(Package/$(1)/description_detail),$(TITLE))
