...
ifeq (TRUE, $(IN_NAT_HELPER))
  SRC_LIST += ../../app/nathelper/linux/lib/nat_helper_dt.c
  SRC_LIST += ../../app/nathelper/linux/lib/nat_helper_hsl.c
  SRC_LIST += ../../app/nathelper/linux/nat_ipt_helper.c
  SRC_LIST += ../../app/nathelper/linux/napt_helper.c
  SRC_LIST += ../../app/nathelper/linux/host_helper.c
  SRC_LIST += ../../app/nathelper/linux/nat_helper.c
  SRC_LIST += ../../app/nathelper/linux/napt_acl.c
  SRC_LIST += ../../app/nathelper/linux/napt_procfs.c
endif
