...
MODULE_CFLAG += $(OPT_FLAG) -Wall #-DOS=\"$(OS)\" -D"KBUILD_STR(s)=\#s" -D"KBUILD_MODNAME=KBUILD_STR(qca-ssdk)"

MODULE_INC += -I$(src)/include \
                   ...
                   -I$(src)/include/adpt \
                   -I$(src)/include/hsl \
                   -I$(src)/include/hsl/phy \
                   -I$(src)/include/sal/os \
                   -I$(src)/include/sal/sd \
                   -I$(src)/include/sal/sd/linux/hydra_howl \
                   -I$(src)/include/sal/sd/linux/uk_interface \
                   -I$(src)/include/init
...
ifneq (,$(findstring SHIVA, $(SUPPORT_CHIP)))
  MODULE_INC   += -I$(src)/include/hsl/shiva
  MODULE_CFLAG += -DSHIVA
endif
...
ifneq (,$(findstring ISIS, $(SUPPORT_CHIP)))
  ifneq (ISISC, $(SUPPORT_CHIP))
     MODULE_INC   += -I$(src)/include/hsl/isis
     MODULE_CFLAG += -DISIS
  endif
endif

ifneq (,$(findstring ISISC, $(SUPPORT_CHIP)))
  MODULE_INC   += -I$(src)/include/hsl/isisc
  MODULE_CFLAG += -DISISC
endif

ifneq (,$(findstring DESS, $(SUPPORT_CHIP)))
  MODULE_INC   += -I$(src)/include/hsl/dess
  MODULE_CFLAG += -DDESS
endif

ifneq (,$(findstring HPPE, $(SUPPORT_CHIP)))
  MODULE_INC   += -I$(src)/include/hsl/hppe
  MODULE_INC   += -I$(src)/include/adpt/hppe
  MODULE_CFLAG += -DHPPE
endif
...
ifeq (KSLIB, $(MODULE_TYPE))
  ...
  MODULE_INC += -I$(src)/include/shell_lib
  ifndef TARGET_NAME
