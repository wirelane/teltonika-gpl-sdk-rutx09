...
#define RTKBT_RELEASE_NAME "20240315_BT_ANDROID_10.0"
...
static patch_info fw_patch_table[] = {
	...
	{ 0x0BDA, 0x1724, 0x1200, 0, 0, "mp_rtl8723a_fw", "rtl8723a_fw", "rtl8723a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723A */
	{ 0x0BDA, 0x8723, 0x1200, 0, 0, "mp_rtl8723a_fw", "rtl8723a_fw", "rtl8723a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* 8723AE */
	{ 0x0BDA, 0xA723, 0x1200, 0, 0, "mp_rtl8723a_fw", "rtl8723a_fw", "rtl8723a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* 8723AE for LI */
	{ 0x0BDA, 0x0723, 0x1200, 0, 0, "mp_rtl8723a_fw", "rtl8723a_fw", "rtl8723a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* 8723AE */
	{ 0x13D3, 0x3394, 0x1200, 0, 0, "mp_rtl8723a_fw", "rtl8723a_fw", "rtl8723a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* 8723AE for Azurewave*/

	{ 0x0BDA, 0x0724, 0x1200, 0, 0, "mp_rtl8723a_fw", "rtl8723a_fw", "rtl8723a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* 8723AU */
	{ 0x0BDA, 0x8725, 0x1200, 0, 0, "mp_rtl8723a_fw", "rtl8723a_fw", "rtl8723a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* 8723AU */
	{ 0x0BDA, 0x872A, 0x1200, 0, 0, "mp_rtl8723a_fw", "rtl8723a_fw", "rtl8723a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* 8723AU */
	{ 0x0BDA, 0x872B, 0x1200, 0, 0, "mp_rtl8723a_fw", "rtl8723a_fw", "rtl8723a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* 8723AU */

	{ 0x0BDA, 0xb720, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723bu_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BU */
	{ 0x0BDA, 0xb72A, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723bu_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BU */
	{ 0x0BDA, 0xb728, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE for LC */
	{ 0x0BDA, 0xb723, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE */
	{ 0x0BDA, 0xb72B, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE */
	{ 0x0BDA, 0xb001, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE for HP */
	{ 0x0BDA, 0xb002, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE */
	{ 0x0BDA, 0xb003, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE */
	{ 0x0BDA, 0xb004, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE */
	{ 0x0BDA, 0xb005, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE */

	{ 0x13D3, 0x3410, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE for Azurewave */
	{ 0x13D3, 0x3416, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE for Azurewave */
	{ 0x13D3, 0x3459, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE for Azurewave */
	{ 0x0489, 0xE085, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE for Foxconn */
	{ 0x0489, 0xE08B, 0x8723, 0, 0, "mp_rtl8723b_fw", "rtl8723b_fw", "rtl8723b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8723BE for Foxconn */

	{ 0x0BDA, 0x2850, 0x8761, 0, 0, "mp_rtl8761a_fw", "rtl8761au_fw", "rtl8761a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8761AU */
	{ 0x0BDA, 0xA761, 0x8761, 0, 0, "mp_rtl8761a_fw", "rtl8761au_fw", "rtl8761a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8761AU only */
	{ 0x0BDA, 0x818B, 0x8761, 0, 0, "mp_rtl8761a_fw", "rtl8761aw8192eu_fw", "rtl8761aw8192eu_config",
	  NULL, 0, CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8761AW + 8192EU */
	{ 0x0BDA, 0x818C, 0x8761, 0, 0, "mp_rtl8761a_fw", "rtl8761aw8192eu_fw", "rtl8761aw8192eu_config",
	  NULL, 0, CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8761AW + 8192EU */
	{ 0x0BDA, 0x8760, 0x8761, 0, 0, "mp_rtl8761a_fw", "rtl8761au8192ee_fw", "rtl8761a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8761AU + 8192EE */
	{ 0x0BDA, 0xB761, 0x8761, 0, 0, "mp_rtl8761a_fw", "rtl8761au_fw", "rtl8761a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8761AUV only */
	{ 0x0BDA, 0x8761, 0x8761, 0, 0, "mp_rtl8761a_fw", "rtl8761au8192ee_fw", "rtl8761a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8761AU + 8192EE for LI */
	{ 0x0BDA, 0x8A60, 0x8761, 0, 0, "mp_rtl8761a_fw", "rtl8761au8812ae_fw", "rtl8761a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8761AU + 8812AE */
	{ 0x0BDA, 0x8771, 0x8761, 0, 0, "mp_rtl8761b_fw", "rtl8761b_fw", "rtl8761b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_40K }, /* RTL8761BU */
	{ 0x0BDA, 0xB771, 0x8761, 0, 0, "mp_rtl8761b_fw", "rtl8761b_fw", "rtl8761b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_40K }, /* RTL8761BU */
	{ 0x0BDA, 0xC761, 0x8761, 0, 0, "mp_rtl8761c_mx_fw", "rtl8761c_mx_fw", "rtl8761c_mx_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_500K }, /* RTL8761C_mx*/
	{ 0x0BDA, 0xa725, 0x8761, 0, 0, "mp_rtl8725a_fw", "rtl8725a_fw", "rtl8725a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_40K }, /* RTL8725AU */
	{ 0x0BDA, 0xa72A, 0x8761, 0, 0, "mp_rtl8725a_fw", "rtl8725a_fw", "rtl8725a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_40K }, /* RTL8725AU BT only */

	{ 0x0BDA, 0x8821, 0x8821, 0, 0, "mp_rtl8821a_fw", "rtl8821a_fw", "rtl8821a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8821AE */
	{ 0x0BDA, 0x0821, 0x8821, 0, 0, "mp_rtl8821a_fw", "rtl8821a_fw", "rtl8821a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8821AE */
	{ 0x0BDA, 0x0823, 0x8821, 0, 0, "mp_rtl8821a_fw", "rtl8821a_fw", "rtl8821a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8821AU */
	{ 0x13D3, 0x3414, 0x8821, 0, 0, "mp_rtl8821a_fw", "rtl8821a_fw", "rtl8821a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8821AE */
	{ 0x13D3, 0x3458, 0x8821, 0, 0, "mp_rtl8821a_fw", "rtl8821a_fw", "rtl8821a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8821AE */
	{ 0x13D3, 0x3461, 0x8821, 0, 0, "mp_rtl8821a_fw", "rtl8821a_fw", "rtl8821a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8821AE */
	{ 0x13D3, 0x3462, 0x8821, 0, 0, "mp_rtl8821a_fw", "rtl8821a_fw", "rtl8821a_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_1_2, MAX_PATCH_SIZE_24K }, /* RTL8821AE */

	{ 0x0BDA, 0xB822, 0x8822, 0, 0, "mp_rtl8822b_fw", "rtl8822b_fw", "rtl8822b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_3PLUS, MAX_PATCH_SIZE_25K }, /* RTL8822BE */
	{ 0x0BDA, 0xB82C, 0x8822, 0, 0, "mp_rtl8822b_fw", "rtl8822b_fw", "rtl8822b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_3PLUS, MAX_PATCH_SIZE_25K }, /* RTL8822BU */
	{ 0x0BDA, 0xB81D, 0x8822, 0, 0, "mp_rtl8822b_fw", "rtl8822b_fw", "rtl8822b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_3PLUS, MAX_PATCH_SIZE_25K }, /* RTL8822BU BT only */
	{ 0x0BDA, 0xB82E, 0x8822, 0, 0, "mp_rtl8822b_fw", "rtl8822b_fw", "rtl8822b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_3PLUS, MAX_PATCH_SIZE_25K }, /* RTL8822BU-VN */
	{ 0x0BDA, 0xB023, 0x8822, 0, 0, "mp_rtl8822b_fw", "rtl8822b_fw", "rtl8822b_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_3PLUS, MAX_PATCH_SIZE_25K }, /* RTL8822BE */
	{ 0x0BDA, 0xB703, 0x8703, 0, 0, "mp_rtl8723c_fw", "rtl8723c_fw", "rtl8723c_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_3PLUS, MAX_PATCH_SIZE_24K }, /* RTL8723CU */
	{ 0x0BDA, 0xC82C, 0x8822, 0, 0, "mp_rtl8822c_fw", "rtl8822c_fw", "rtl8822c_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_40K }, /* RTL8822CU */
	{ 0x0BDA, 0xC82E, 0x8822, 0, 0, "mp_rtl8822c_fw", "rtl8822c_fw", "rtl8822c_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_40K }, /* RTL8822CU-VN */
	{ 0x0BDA, 0xC81D, 0x8822, 0, 0, "mp_rtl8822c_fw", "rtl8822c_fw", "rtl8822c_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_40K }, /* RTL8822CU BT only */
	{ 0x0BDA, 0xC82F, 0x8822, 0, 0, "mp_rtl8822c_fw", "rtl8822c_fw", "rtl8822c_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_40K }, /* RTL8822CE-VS */
	{ 0x0BDA, 0xC822, 0x8822, 0, 0, "mp_rtl8822c_fw", "rtl8822c_fw", "rtl8822c_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_40K }, /* RTL8822CE */
	{ 0x0BDA, 0xB00C, 0x8822, 0, 0, "mp_rtl8822c_fw", "rtl8822c_fw", "rtl8822c_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_40K }, /* RTL8822CE */
	{ 0x0BDA, 0xA82A, 0x8822, 0, 0, "mp_rtl8822e_8822c_fw", "rtl8822e_8822c_fw", "rtl8822e_8822c_config",
	  NULL, 0, CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_145K }, /* RTL8822EU */
	{ 0x0BDA, 0xA82B, 0x8822, 0, 0, "mp_rtl8822e_8822c_fw", "rtl8822e_8822c_fw", "rtl8822e_8822c_config",
	  NULL, 0, CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_145K }, /* RTL8822EU */
	{ 0x0BDA, 0xA822, 0x8822, 0, 0, "mp_rtl8822e_8822c_fw", "rtl8822e_8822c_fw", "rtl8822e_8822c_config",
	  NULL, 0, CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_145K }, /* RTL8822EU */
	{ 0x0BDA, 0xE822, 0x8822, 0, 0, "mp_rtl8822e_8822c_fw", "rtl8822e_8822c_fw", "rtl8822e_8822c_config",
	  NULL, 0, CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE
_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_78K }, /*RTL8852C */
	{ 0x0CB8, 0xC558, 0x8852, 0, 0, "mp_rtl8852cu_fw", "rtl8852cu_fw", "rtl8852cu_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_78K }, /*RTL8852C */
	{ 0x13D3, 0x3587, 0x8852, 0, 0, "mp_rtl8852cu_fw", "rtl8852cu_fw", "rtl8852cu_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_78K }, /*RTL8852C */
	{ 0x13D3, 0x3586, 0x8852, 0, 0, "mp_rtl8852cu_fw", "rtl8852cu_fw", "rtl8852cu_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_78K }, /*RTL8852C */
	//RTL8852BP
	{ 0x0BDA, 0xA85C, 0x8852, 0, 0, "mp_rtl8852bpu_fw", "rtl8852bpu_fw", "rtl8852bpu_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_65_2K }, /*RTL8852BP */
	{ 0x0BDA, 0xA850, 0x8852, 0, 0, "mp_rtl8852bpu_fw", "rtl8852bpu_fw", "rtl8852bpu_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_65_2K }, /*RTL8852BPE */
	//RTL8852DU
	{ 0x0BDA, 0xD85A, 0x8852, 0, 0, "mp_rtl8852du_fw", "rtl8852du_fw", "rtl8852du_config", NULL, 0,
	  CONFIG_MAC_OFFSET_GEN_4PLUS, MAX_PATCH_SIZE_131K }, /*RTL8852D */
...
static void print_acl(struct sk_buff *skb, int direction)
{
	...
	RTK_INFO("%s: direction %d, handle %04x, len %d", __func__, direction, *handle, len);
#endif
}
...
static void print_sco(struct sk_buff *skb, int direction)
{
	...
	RTKBT_INFO("%s: direction %d, handle %04x, len %d", __func__, direction, *handle, len);
#endif
}
...
static inline ssize_t usb_put_user(struct sk_buff *skb, char __user *buf, int count)
{
	char __user *ptr = buf;
...
static bool rtk_copy_capture_data_to_alsa(struct btusb_data *data, uint8_t *p_data, unsigned int frames)
{
	...
	if (pSCOSnd->capture.buffer_pos + frames <= runtime->buffer_size) {
		...
		memcpy(runtime->dma_area, p_data + frames1 * frame_bytes, (frames - frames1) * frame_bytes);
	}
...
static int hci_reassembly(struct hci_dev *hdev, int type, void *data, int count, __u8 index)
{
	int len	   = 0;
	int hlen   = 0;
	int remain = count;
	...
	if ((type < HCI_ACLDATA_PKT || type > HCI_ISODATA_PKT) || index >= NUM_REASSEMBLY) {
		return -EILSEQ;
	}
...
static ssize_t btchr_read(struct file *file_p, char __user *buf_p, size_t count, loff_t *pos_p)
{
	struct hci_dev *hdev;
	struct sk_buff *skb;
	ssize_t ret = 0;
...
static ssize_t btchr_write(struct file *file_p, const char __user *buf_p, size_t count, loff_t *pos_p)
{
...
static unsigned int btchr_poll(struct file *file_p, poll_table *wait)
{
	...
	if ((get_driver_state_value() & DRIVER_ON) == 0 || (get_driver_state_value() & DEVICE_PROBED) == 0) {
		RTKBT_ERR("%s: Device not probed", __func__);
		return POLLERR | POLLHUP;
	}
...
static long btchr_ioctl(struct file *file_p, unsigned int cmd, unsigned long arg)
{
	...
	case DWFW_CMPLT: {
		...
		RTKBT_INFO("%s lmp_sub = 0x%x, patch_entry->lmp_sub = 0x%x", __func__, lmp_sub,
			   fw_info->patch_entry->lmp_sub);
	} break;
...
int send_hci_cmd(firmware_info *fw_info)
{
	...
	while ((ret_val < 0) && (i++ < 10)) {
		ret_val = usb_control_msg(fw_info->udev, fw_info->pipe_out, 0, USB_TYPE_CLASS, 0, 0,
					  (void *)(fw_info->send_pkt), fw_info->pkt_len, MSG_TO);
	}
	return ret_val;
}
...
int rcv_hci_evt(firmware_info *fw_info)
{
	...
	while (1) {
		for (i = 0; i < 5; i++) {
			ret_val = usb_interrupt_msg(fw_info->udev, fw_info->pipe_in,
						    (void *)(fw_info->rcv_pkt), PKT_LEN, &ret_len, MSG_TO);
			if (ret_val >= 0) {
				break;
			}
		}
...
int set_bt_onoff(firmware_info *fw_info, uint8_t onoff)
{
	...
	if (ret_val < 0) {
		RTKBT_ERR("%s: Failed to send bt %s cmd, errno %d", __func__, onoff != 0 ? "on" : "off",
			  ret_val);
		return ret_val;
	}
...
static struct rtk_epatch_entry *get_fw_patch_entry(struct rtk_epatch *epatch_info, uint16_t eco_ver)
{
	...
	for (i = 0; i < patch_num; i++) {
		if (*(uint16_t *)(epatch_buf + 14 + 2 * i) == eco_ver + 1) {
			...
			p_entry->coex_version = *(uint32_t *)(epatch_buf + p_entry->start_offset +
							      p_entry->patch_length - 12);
			p_entry->svn_version =
				*(uint32_t *)(epatch_buf + p_entry->start_offset + p_entry->patch_length - 8);
			p_entry->fw_version =
				*(uint32_t *)(epatch_buf + p_entry->start_offset + p_entry->patch_length - 4);
			...
			RTKBT_INFO(
				"BTCOEX:20%06d-0x%04x svn version:0x%08x fw version:0x%08x rtk_btusb version:%s Cut:%d, patch length:0x%04x, patch offset:0x%08x\n",

				coex_date, coex_ver, p_entry->svn_version, p_entry->fw_version, VERSION,
...
int reset_controller(firmware_info *fw_info)
{
	...
	if (ret_val < 0) {
		RTKBT_ERR("%s: Failed to send hci cmd 0x%04x, errno %d", __func__, fw_info->cmd_hdr->opcode,
			  ret_val);
		return ret_val;
	}
...
int check_fw_version(firmware_info *fw_info, bool resume_check)
{
	...
	while (1) {
		...
		if (ret_val < 0) {
			RTKBT_ERR("%s: Failed to receive hci event, errno %d", __func__, ret_val);
			return ret_val;
		}
	...
	RTKBT_INFO("%s: Controller lmp = 0x%04x, patch lmp = 0x%04x, default patch lmp = 0x%04x", __func__,
		   read_ver_rsp->lmp_subver, patch_entry->lmp_sub, patch_entry->lmp_sub_default);
...
bool reset_and_clean_hw_buffer(firmware_info *fw_info)
{
	...
	while (1) {
		ret_val = usb_interrupt_msg(fw_info->udev, fw_info->pipe_in, (void *)(fw_info->rcv_pkt),
					    PKT_LEN, &ret_len, (MSG_TO / 4));
...
void rtk_update_altsettings(patch_info *patch_entry, const unsigned char *org_config_buf, int org_config_len,
			    unsigned char **new_config_buf_ptr, int *new_config_len_ptr)
{
	...
	*new_config_len_ptr = org_config_len;
	...
	for (i = 0; i <= org_config_len; i += 0x10) {
		RTKBT_INFO(
			...
			i, config_buf[i], config_buf[i + 1], config_buf[i + 2], config_buf[i + 3],
			config_buf[i + 4], config_buf[i + 5], config_buf[i + 6], config_buf[i + 7],
			config_buf[i + 8], config_buf[i + 9], config_buf[i + 10], config_buf[i + 11],
			config_buf[i + 12], config_buf[i + 13], config_buf[i + 14], config_buf[i + 15]);
	}
	...
	for (i = 0; i < config->data_len;) {
		...
		if (getAltSettingVal(patch_entry, entry->offset, val) == entry->entry_len) {
			RTKBT_INFO("rtk_update_altsettings: replace %04x[%02x]", entry->offset,
				   entry->entry_len);
...
int load_firmware(firmware_info *fw_info, uint8_t **buff)
{
	...
	RTKBT_INFO("%s: Default lmp version = 0x%04x, config file name[%s], "
		   "fw file name[%s]",
		   __func__, lmp_version, config_name, fw_name);
	...
	if (ret_val < 0) {
		...
		for (i = 0; i <= config_len; i += 0x10) {
			RTKBT_INFO(
				"%08x: %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x\n",
				i, config_file_buf[i], config_file_buf[i + 1], config_file_buf[i + 2],
				config_file_buf[i + 3], config_file_buf[i + 4], config_file_buf[i + 5],
				config_file_buf[i + 6], config_file_buf[i + 7], config_file_buf[i + 8],
				config_file_buf[i + 9], config_file_buf[i + 10], config_file_buf[i + 11],
				config_file_buf[i + 12], config_file_buf[i + 13], config_file_buf[i + 14],
				config_file_buf[i + 15]);
		}
	...
	if (lmp_version == ROM_LMP_8723a) {
		...
		if (!memcmp(epatch_buf, RTK_EPATCH_SIGNATURE, 8)) {
			...
			if (!(buf = kzalloc(buf_len, GFP_KERNEL))) {
				...
				RTKBT_DBG("%s: Config lmp version = 0x%04x", __func__, patch_entry->lmp_sub);
				vfree(epatch_buf);
		...
		if (memcmp(epatch_buf + buf_len - config_len - 4, EXTENSION_SECTION_SIGNATURE, 4)) {
			...
			if (lmp_version != project_id[*(patch_lmp.data)]) {
				RTKBT_ERR("%s: Default lmp_version 0x%04x, project_id[%d] 0x%04x "
					  "-> not match",
					  __func__, lmp_version, *(patch_lmp.data),
					  project_id[*(patch_lmp.data)]);
				...
				if (memcmp(epatch_buf, RTK_EPATCH_SIGNATURE, 8)) {
					...
					RTKBT_DBG("%s: lmp version 0x%04x, fw_version 0x%x, "
						  "number_of_total_patch %d",
						  __func__, patch_entry->lmp_sub, epatch_info->fw_version,
						  epatch_info->number_of_total_patch);

					/* Get right epatch entry */
					p_epatch_entry =
						get_fw_patch_entry(epatch_info, patch_entry->eversion);
					...
					if (!(buf = kzalloc(buf_len, GFP_KERNEL))) {
						...
						memcpy(buf, &epatch_buf[p_epatch_entry->start_offset],
						       p_epatch_entry->patch_length);
						memcpy(&buf[p_epatch_entry->patch_length - 4],
						       &epatch_info->fw_version, 4);
						kfree(p_epatch_entry);
						p_epatch_entry = NULL;
					}
					vfree(epatch_buf);
	...
	RTKBT_INFO("%s: fw%s exists, config file%s exists", __func__, (buf_len > 0) ? "" : " not",
		   (config_len > 0) ? "" : " not");
...
static int load_suspend_firmware(firmware_info *fw_info, uint8_t **buff)
{
	...
	if (memcmp(epatch_buf + buf_len - config_len - 4, EXTENSION_SECTION_SIGNATURE, 4)) {
		...
		if (lmp_version != project_id[*(patch_lmp.data)]) {
			RTKBT_ERR("%s: Default lmp_version 0x%04x, project_id[%d] 0x%04x "
				  "-> not match",
				  __func__, lmp_version, *(patch_lmp.data), project_id[*(patch_lmp.data)]);
			if (patch_lmp.data) {
				kfree(patch_lmp.data);
				patch_lmp.data = NULL;
			}
...
int download_data(firmware_info *fw_info)
{
	...
	for (i = 0; i < frag_num; i++) {
		...
		while (ncmd > 0) {
			...
			if (0 != evt_para->status) {
				RTKBT_ERR("%s: Receive acked frag num %d, err status %d", __func__, ret_val,
					  evt_para->status);
				return -1;
			}
	...
	RTKBT_INFO("%s: done, sent %d frag pkts, received %d frag events", __func__, cmd_para->index,
		   evt_para->index);
		...
		if (num) {
			for (i = 0; i < num; i++) {
				...
				RTKBT_DBG("paired_wakeup_bdaddr: 0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x",
					  paired_wakeup_bdaddr[1], paired_wakeup_bdaddr[2],
					  paired_wakeup_bdaddr[3], paired_wakeup_bdaddr[4],
					  paired_wakeup_bdaddr[5], paired_wakeup_bdaddr[6]);
...
static void btusb_intr_complete(struct urb *urb)
{
	...
	RTKBT_DBG("%s: urb %p status %d count %d ", __func__, urb, urb->status, urb->actual_length);
	...
	if (err < 0) {
		...
		if (err != -EPERM && err != -ENODEV)
			RTKBT_ERR("%s: Failed to re-submit urb %p, err %d", __func__, urb, err);
...
static int btusb_submit_intr_urb(struct hci_dev *hdev, gfp_t mem_flags)
{
	...
	RTKBT_DBG("%s: mMaxPacketSize %d, bEndpointAddress 0x%02x", __func__, size,
		  data->intr_ep->bEndpointAddress);

	pipe = usb_rcvintpipe(data->udev, data->intr_ep->bEndpointAddress);

	usb_fill_int_urb(urb, data->udev, pipe, buf, size, btusb_intr_complete, hdev,
...
static void btusb_bulk_complete(struct urb *urb)
{
	...
	if (err < 0) {
         ...
         * -ENODEV: device got disconnected */
		if (err != -EPERM && err != -ENODEV)
			RTKBT_ERR("btusb_bulk_complete %s urb %p failed to resubmit (%d)", hdev->name, urb,
				  -err);
		usb_unanchor_urb(urb);
	}
}
...
static int btusb_submit_bulk_urb(struct hci_dev *hdev, gfp_t mem_flags)
{
	...
	usb_fill_bulk_urb(urb, data->udev, pipe, buf, size, btusb_bulk_complete, hdev);
...
static void btusb_isoc_complete(struct urb *urb)
{
	...
	if (urb->status == 0) {
		for (i = 0; i < urb->number_of_packets; i++) {
			...
			if (hci_recv_fragment(hdev, HCI_SCODATA_PKT, urb->transfer_buffer + offset, length) <
			    0) {
...
retry:
	...
	if (err < 0) {
         ...
         * -ENODEV: device got disconnected */
		if (err != -EPERM && err != -ENODEV)
			RTKBT_ERR("%s: Failed to re-sumbit urb %p, retry %d, err %d", __func__, urb, i, err);
		if (i < 10) {
			i++;
			mdelay(1);
			goto retry;
...
static int btusb_submit_isoc_urb(struct hci_dev *hdev, gfp_t mem_flags)
{
	...
	fill_isoc_descriptor(urb, size, le16_to_cpu(data->isoc_rx_ep->wMaxPacketSize));
...
static int snd_send_sco_frame(struct sk_buff *skb)
{
	...
	RTKBT_DBG("%s:pkt type %d, packet_len : %d", __func__, bt_cb(skb)->pkt_type, skb->len);
	...
	usb_fill_int_urb(urb, data->udev, pipe, skb->data, skb->len, btusb_isoc_snd_tx_complete, skb,
			 data->isoc_tx_ep->bInterval);

	urb->transfer_flags = URB_ISO_ASAP;

	fill_isoc_descriptor(urb, skb->len, le16_to_cpu(data->isoc_tx_ep->wMaxPacketSize));
	...
	err = usb_submit_urb(urb, GFP_ATOMIC);
	if (err < 0) {
		RTKBT_ERR("%s: Failed to submit urb %p, pkt type %d, err %d", __func__, urb,
			  bt_cb(skb)->pkt_type, err);
		kfree(urb->setup_packet);
		usb_unanchor_urb(urb);
	} else {
		usb_mark_last_busy(data->udev);
...
static bool snd_copy_send_sco_data(RTK_sco_card_t *pSCOSnd)
{
	...
	for (i = 0; i < count; i++) {
		*((__u16 *)(skb->data + i * (sco_packet_bytes + HCI_SCO_HDR_SIZE))) =
...
static void btusb_isoc_snd_tx_complete(struct urb *urb)
{
	...
	if (skb) {
		...
		if (hdev) {
			...
			RTKBT_DBG("%s: status %d count %d", __func__, urb->status, urb->actual_length);
...
static int btusb_send_frame(struct sk_buff *skb)
{
	...
	RTKBT_DBG("%s: hdev %p, btusb data %p, pkt type %d", __func__, hdev, data, bt_cb(skb)->pkt_type);
	...
	case HCI_COMMAND_PKT:
		...
		usb_fill_control_urb(urb, data->udev, pipe, (void *)dr, skb->data, skb->len,
	...
	case HCI_ACLDATA_PKT:
		...
		usb_fill_bulk_urb(urb, data->udev, pipe, skb->data, skb->len, btusb_tx_complete, skb);
	...
	case HCI_SCODATA_PKT:
		...
		usb_fill_int_urb(urb, data->udev, pipe, skb->data, skb->len, btusb_isoc_tx_complete, skb,
				 data->isoc_tx_ep->bInterval);
...
retry:
	err = usb_submit_urb(urb, GFP_ATOMIC);
	if (err < 0) {
		RTKBT_ERR("%s: Failed to submit urb %p, pkt type %d, err %d, retries %d", __func__, urb,
			  bt_cb(skb)->pkt_type, err, retries);
...
static inline int set_isoc_interface(struct hci_dev *hdev, int altsetting)
{
	...
	if (err < 0) {
		RTKBT_ERR("%s: Failed to set interface, altsetting %d, err %d", __func__, altsetting, err);
		return err;
	}
				      ...
				      struct btusb_data *data)
{
	...
	int err = 0;
	RTKBT_INFO("%s", __func__);
	err = snd_card_new(&intf->dev, -1, RTK_SCO_ID, THIS_MODULE, sizeof(RTK_sco_card_t), &card);
	if (err < 0) {
	...
	sprintf(card->longname, "Realtek sco over hci: VID:0x%04x, PID:0x%04x", id->idVendor,
		pSCOSnd->dev->descriptor.idProduct);
	...
	sprintf(pSCOSnd->pcm->name, "sco_pcm:VID:0x%04x, PID:0x%04x", id->idVendor,
		pSCOSnd->dev->descriptor.idProduct);
...
static int btusb_probe(struct usb_interface *intf, const struct usb_device_id *id)
{
	...
	RTKBT_INFO("%s: usb_interface %p, bInterfaceNumber %d, idVendor 0x%04x, "
		   "idProduct 0x%04x",
		   __func__, intf, intf->cur_altsetting->desc.bInterfaceNumber, id->idVendor, id->idProduct);
	...
	RTKBT_DBG("%s: can wakeup = %x, may wakeup = %x", __func__, device_can_wakeup(&udev->dev),
...
static void btusb_disconnect(struct usb_interface *intf)
{
	...
	RTKBT_INFO("%s: usb_interface %p, bInterfaceNumber %d", __func__, intf,
...
static int btusb_suspend(struct usb_interface *intf, pm_message_t message)
{
	...
	RTKBT_INFO("%s: event 0x%x, suspend count %d", __func__, message.event, data->suspend_count);
