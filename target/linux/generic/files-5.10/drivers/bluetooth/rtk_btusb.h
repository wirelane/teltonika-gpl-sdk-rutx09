...
uint16_t project_id[] = {
	ROM_LMP_8723a,	ROM_LMP_8723b, ROM_LMP_8821a, ROM_LMP_8761a, ROM_LMP_8703a,
	ROM_LMP_8763a,	ROM_LMP_8703b, ROM_LMP_8723c, ROM_LMP_8822b, ROM_LMP_8723d,
	ROM_LMP_8821c,	ROM_LMP_NONE,  ROM_LMP_NONE,
	ROM_LMP_8822c, //0x0d
	ROM_LMP_8761b,	ROM_LMP_NONE,
	ROM_LMP_NONE, //0x10
	ROM_LMP_NONE,
	ROM_LMP_8852a, //0x12
	ROM_LMP_8723f,	ROM_LMP_8852b,
	ROM_LMP_8763c, //bbpro2
	ROM_LMP_8773b, //bblite
	ROM_LMP_8762a, //bee
	ROM_LMP_8762b, //bee2
	ROM_LMP_8852c,	ROM_LMP_NONE,  ROM_LMP_NONE,  ROM_LMP_NONE,  ROM_LMP_NONE,
	ROM_LMP_NONE,	ROM_LMP_NONE,  ROM_LMP_NONE,  ROM_LMP_8822e,
	ROM_LMP_8852bp, //34 8852bp
	ROM_LMP_8851a,	ROM_LMP_8851b, ROM_LMP_NONE,  ROM_LMP_NONE,  ROM_LMP_NONE,
	ROM_LMP_NONE,	ROM_LMP_NONE,
	ROM_LMP_8852d, //42 8852d
	ROM_LMP_NONE,	ROM_LMP_NONE,  ROM_LMP_NONE,  ROM_LMP_NONE,
	ROM_LMP_8852bt, //47 8852bt
	ROM_LMP_NONE,	ROM_LMP_NONE,  ROM_LMP_NONE,
...
#define CONFIG_MAC_OFFSET_GEN_1_2                                                                            \
	(0x3C) //MAC's OFFSET in config/efuse for realtek generation 1~2 bluetooth chip
...
enum rtk_endpoit { CTRL_EP = 0, INTR_EP = 1, BULK_EP = 2, ISOC_EP = 3 };
	...
	if (ret == FACTORY_BT_BDADDR_STORAGE_LEN) {
		for (i = 0; i < 6; i++) {
			...
			vnd_local_bd_addr[5 - i] =
				((uint8_t)buf[3 * i] - '0') * 16 + ((uint8_t)buf[3 * i + 1] - '0');
		}
		return 0;
	}
#endif
...
static inline int getAltSettingVal(patch_info *patch_entry, unsigned short offset, unsigned char *val)
{
    ...
    */
	...
	if ((patch_entry) && (offset == patch_entry->mac_offset) && (res == 0)) {
		if (getmacaddr(val) == 0) {
			RTKBT_INFO("MAC: %02x:%02x:%02x:%02x:%02x:%02x", val[5], val[4], val[3], val[2],
				   val[1], val[0]);
			res = 6;
		}
	}
