...
## Prerequisites
	...
	is accessible from "RUTX_R_GPL_00.07.11.1/scripts/dockerbuild".
...
## Building with Docker environment
	...
	2. Extract the  archive to an empty folder
		...
		$ mkdir RUTX_R_GPL_00.07.11.1
		$ tar -xzf ~/Downloads/RUTX_R_GPL_00.07.11.1.tar.gz -C RUTX_R_GPL_00.07.11.1

	3. Update feeds

		$ cd RUTX_R_GPL_00.07.11.1
	...
	5. Prepare packages for offline installation (optional)
		...
		After this you can find packages in "RUTX_R_GPL_00.07.11.1/bin/packages/<arch_name>/zipped_packages".
...
## Installation
	...
	After successful build you will get the firmware file in
		"RUTX_R_GPL_00.07.11.1/bin/targets/ipq40xx/generic/tltFws".
...
## WebUI rebranding
	...
	All changes should be done in "RUTX_R_GPL_00.07.11.1/package/feeds/vuci/vuci-ui-core/bin/dist" folder.
...
## SSH Banner
	...
	2. Use figlet tool to generate needed text:
		...
		$ figlet YOUR_TEXT > "RUTX_R_GPL_00.07.11.1/package/base-files/files/etc/banner.logo"
...
## Default Password Change
	...
	To change the default device password changes need to be made inside "RUTX_R_GPL_00.07.11.1/package/base-files/files/lib/preinit/84_set_password" file.
